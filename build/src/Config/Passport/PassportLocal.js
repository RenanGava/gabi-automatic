...
exports.configPassPortLocal = new LocalStrategy({ usernameField: "email" }, (email, password, done) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (verifyPassword) {
        ...
        return done(undefined, {
            userData,
            token: (0, jsonwebtoken_1.sign)(userData, process.env.JWT_SECRET, {
                expiresIn: '1h'
            })
        });
    }
